...
const NAV_ITEMS = [
  ...
  { key: 'credits-plans', icon: 'credit-card', label: 'Credits & Plans' },
  ...
  { key: 'analytics', icon: 'chart-bar', label: 'Analytics' },
  { key: 'disputes', icon: 'cog', label: 'Disputes' },
  { key: 'promotions', icon: 'document', label: 'Promotions' },
  { key: 'reviews', icon: 'chart-bar', label: 'Reviews' },
  { key: 'pricing', icon: 'cog', label: 'Pricing' },
];
      ...
      <nav className="px-2.5 flex flex-col gap-0.5 flex-1">
          ...
          return (
            <div
              ...
              className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl cursor-pointer relative transition-colors
                ${active
                  ? 'bg-gradient-to-br from-[#D61CA8] to-[#8B2EF5] border-l-3 border-primary'
                  : 'hover:bg-white/5'
                }`}
            >
              <Icon name={item.icon} className={active ? 'text-primary' : 'text-white/40'} />
              <span className={`font-medium text-[13px] leading-none ${active ? 'text-white' : 'text-white/50'
                }`}>
                {item.label}
              </span>
              {item.badge && (
        ...
        <div
          ...
          className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl cursor-pointer mt-1.5 transition-colors
            ${activePage === 'settings' ? 'bg-gradient-to-br  from-[#D61CA8] to-[#8B2EF5]  border-l-3 border-primary' : 'hover:bg-white/5'}`}
        >
